...
if __name__ == '__main__':
    ...
    lines_layer = DrawLines(xy0_range, xy1_range, radius_range,
                            thickness_range, color_range, input_size=(width_begin, height_begin))
    ...
    perspective_layer = Perspective(output_dim=(width_end, height_end))
    crop_layer = Crop(output_dim=(width_end, height_end))
    ...
    simulator.generate(n_examples=100, path='sample_dim')
